...
export default function ReportsPage() {
  ...
  // React Query hooks
  const { data: loadsData = [], isLoading: loadingLoads } =
    useLoadLitersScoped();
        ...
        {tipoReporte === "ranking-eficiencia" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Los vehículos con menor consumo promedio por carga se consideran
                más eficientes
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <TableBody>
                      {rankingEficiencia.map((item) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge variant="secondary">{item.tendencia}</Badge>
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
